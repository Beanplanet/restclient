...
public class StringBodyTest extends AbstractContainerisedTest {
    @Test
    void givenARequest_whenSent_thenADefaultContentTypeIsSet_andTheRequestIsSentCorrectly() {
        ...
        assertThat(res.getHeaders().get(HttpHeaders.CONTENT_TYPE), equalTo(MediaTypes.Text.PLAIN.getCanonicalForm()));
